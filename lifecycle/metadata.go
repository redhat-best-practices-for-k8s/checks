...
// Exception processes
const (
	LifecycleAffinityRequiredPodsExceptionProcess = `There is no documented exception process for this.`
	...
	LifecycleCpuIsolationExceptionProcess = `There is no documented exception process for this.`
	...
	LifecycleImagePullPolicyExceptionProcess = `There is no documented exception process for this.`

	LifecycleLivenessProbeExceptionProcess = `There is no documented exception process for this.`

	LifecyclePersistentVolumeReclaimPolicyExceptionProcess = `There is no documented exception process for this.`
	...
	LifecyclePodTolerationBypassExceptionProcess = `There is no documented exception process for this.`

	LifecycleReadinessProbeExceptionProcess = `There is no documented exception process for this.`

	LifecycleStartupProbeExceptionProcess = `There is no documented exception process for this.`
	...
	LifecycleStorageProvisionerExceptionProcess = `No exceptions`

	LifecycleTopologySpreadConstraintExceptionProcess = `There is no documented exception process for this.`

...
func init() {
	...
	// Resource requests
	checks.Register(checks.CheckInfo{
		Name: "access-control-pod-requests", Category: "access-control",
		...
		CatalogID:   "access-control-requests-and-limits",
		Fn:          CheckPodRequests,
	})

	// Shared process namespace capability
	checks.Register(checks.CheckInfo{
		Name: "access-control-sys-ptrace", Category: "access-control",

...
func Register() {
	once.Do(func() {
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-sys-admin-capability-check", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-net-admin-capability-check", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-net-raw-capability-check", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-ipc-lock-capability-check", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-bpf-capability-check", Category: "access-control",
		...
		// Host checks
		checks.Register(checks.CheckInfo{
			Name: "access-control-pod-host-network", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-pod-host-path", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-pod-host-ipc", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-pod-host-pid", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-security-context-non-root-user-id-check", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-security-context-privilege-escalation", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-security-context-read-only-file-system", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-no-1337-uid", Category: "access-control",
		...
		// RBAC checks
		checks.Register(checks.CheckInfo{
			Name: "access-control-pod-service-account", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-pod-role-bindings", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-pod-automount-service-account-token", Category: "access-control",
		...
		// Service checks
		checks.Register(checks.CheckInfo{
			Name: "access-control-service-type", Category: "access-control",
		...
		// Resource requests
		checks.Register(checks.CheckInfo{
			Name: "access-control-requests", Category: "access-control",
			Description: "Verifies all containers have CPU and memory resource requests set",
			Remediation: "Set resources.requests.cpu and resources.requests.memory on all containers",
			CatalogID:   "access-control-requests",
			Fn:          CheckPodRequests,
		})

		// Shared process namespace capability
		checks.Register(checks.CheckInfo{
			Name: "access-control-sys-ptrace-capability", Category: "access-control",
			Description: "Verifies pods with shareProcessNamespace have SYS_PTRACE capability",
			Remediation: "Add SYS_PTRACE to capabilities.add on a container in the pod",
		...
		// CRD role validation
		checks.Register(checks.CheckInfo{
			Name: "access-control-crd-roles", Category: "access-control",
			Description: "Verifies Roles only grant permissions on CRD resources",
			Remediation: "Restrict Role rules to only reference CRD resources",
		...
		// Probe-based checks
		checks.Register(checks.CheckInfo{
			Name: "access-control-one-process-per-container", Category: "access-control",
		...
		checks.Register(checks.CheckInfo{
			Name: "access-control-ssh-daemons", Category: "access-control",
		...
		// SYS_NICE capability for real-time workloads
		checks.Register(checks.CheckInfo{
			Name: "access-control-sys-nice-realtime-capability", Category: "access-control",
			Description: "Verifies real-time pods have SYS_NICE capability",
			Remediation: "Add SYS_NICE to securityContext.capabilities.add for real-time workloads",

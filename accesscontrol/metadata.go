...
const (
	AccessControlBpfCapabilityCheckBestPracticeRef = `No Doc Link - Telco`
	...
	AccessControlNo1337UidBestPracticeRef = `No Doc Link - Extended`
...
const (
	...
	AccessControlCrdRolesExceptionProcess = `No exception needed for optional/extended tests.`
	...
	AccessControlNamespaceExceptionProcess = `No exceptions`

	AccessControlNamespaceResourceQuotaExceptionProcess = `No exception needed for optional/extended tests.`
	...
	AccessControlNo1337UidExceptionProcess = `No exception needed for optional/extended tests.`
	...
	AccessControlPodRoleBindingsExceptionProcess = `No exceptions`

	AccessControlPodServiceAccountExceptionProcess = `No exceptions`
	...
	AccessControlSecurityContextPrivilegeEscalationExceptionProcess = `No exceptions`

	AccessControlSecurityContextReadOnlyFileSystemExceptionProcess = `No exceptions`
	...
	AccessControlSysAdminCapabilityCheckExceptionProcess = `No exceptions`

	AccessControlSysNiceRealtimeCapabilityExceptionProcess = `There is no documented exception process for this.`

	AccessControlSysPtraceCapabilityExceptionProcess = `There is no documented exception process for this.`

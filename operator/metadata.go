...
// Exception processes
const (
	OperatorCatalogsourceBundleCountExceptionProcess = `No exceptions`

	OperatorCrdOpenapiSchemaExceptionProcess = `No exceptions`

	OperatorCrdVersioningExceptionProcess = `No exceptions`

	OperatorInstallSourceExceptionProcess = `No exceptions`

	OperatorInstallStatusNoPrivilegesExceptionProcess = `No exceptions`

	OperatorInstallStatusSucceededExceptionProcess = `No exceptions`

	OperatorMultipleSameOperatorsExceptionProcess = `No exceptions`
	...
	OperatorPodsNoHugepagesExceptionProcess = `No exceptions`

	OperatorSemanticVersioningExceptionProcess = `No exceptions`

	OperatorSingleCrdOwnerExceptionProcess = `No exceptions`

	OperatorSingleOrMultiNamespacedAllowedInTenantNamespacesExceptionProcess = `No exceptions`

...
func Register() {
	once.Do(func() {
		...
		checks.Register(checks.CheckInfo{
			Name:                  "networking-tls-minimum-version",
			Category:              checks.CategoryNetworking,
			CatalogID:             "networking-tls-minimum-version",
			Fn:                    CheckTLSMinimumVersion,
			Description:           NetworkingTLSMinimumVersionDescription,
			Remediation:           NetworkingTLSMinimumVersionRemediation,
			BestPracticeReference: NetworkingTLSMinimumVersionBestPracticeRef,
			ExceptionProcess:      NetworkingTLSMinimumVersionExceptionProcess,
			ImpactStatement:       NetworkingTLSMinimumVersionImpactStatement,
			Qe:                    true,
			Tags:                  []string{checks.TagExtended},
			CategoryClassification: map[string]string{
				checks.FarEdge:  checks.Optional,
		...
		checks.Register(checks.CheckInfo{
			Name:                  "networking-unsecured-container-ports",
			Category:              checks.CategoryNetworking,
			CatalogID:             "networking-unsecured-container-ports",
			Fn:                    CheckUnsecuredContainerPorts,
			Description:           NetworkingUnsecuredContainerPortsDescription,
			Remediation:           NetworkingUnsecuredContainerPortsRemediation,
			BestPracticeReference: NetworkingUnsecuredContainerPortsBestPracticeRef,
			ExceptionProcess:      NetworkingUnsecuredContainerPortsExceptionProcess,
			ImpactStatement:       NetworkingUnsecuredContainerPortsImpactStatement,
			Qe:                    true,
			Tags:                  []string{checks.TagExtended},
			CategoryClassification: map[string]string{
				checks.FarEdge:  checks.Optional,
